...
export default function Page() {
  return (
    <div>
      <main className="min-h-screen bg-gradient-to-br from-amber-900 via-amber-800 to-amber-900 flex items-center justify-center px-4 py-10">
        <div className="w-full max-w-5xl bg-gradient-to-br from-amber-50 via-orange-50 to-amber-100 rounded-xl shadow-2xl border-4 border-amber-800 flex flex-col md:flex-row relative overflow-hidden">
          ...
          <div className="flex-1 p-4 md:p-6 flex flex-col bg-gradient-to-br from-orange-50 to-amber-50">
            <div className="flex gap-2 mb-6">
              ...
              <Button
                size="sm"
                variant="ghost"
                className="text-amber-800 hover:bg-amber-200 hover:text-amber-900"
              >
                Namecard
              </Button>
            </div>
            ...
            <div className="mt-auto pt-6 flex flex-col gap-4 border-t-2 border-amber-300">
